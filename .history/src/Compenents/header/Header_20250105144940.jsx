...
const Header = () => {
  ...
  return (
    <header className="fixed w-full top-0 z-50 bg-gradient-to-r from-rgb(26, 25, 29) via-blue-800 to-blue-900">
      <div className="absolute inset-0 bg-[linear-gradient(45deg,transparent_25%,rgb(26, 25, 29)_50%,transparent_75%)] bg-[length:20px_20px]"></div>
