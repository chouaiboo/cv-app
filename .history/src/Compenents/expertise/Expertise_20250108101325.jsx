...
export default function ExpertiseSection() {
  ...
  return (
    <div className="relative min-h-screen bg-[#1B202A]">
      {/* Fond avec motif subtil */}
      <div className="absolute inset-0 opacity-5 bg-[#202836]">
        {[...Array(50)].map((_, i) => (
          <div
            key={i}
      ...
      <div className="relative container mx-auto px-4 py-20 bg-[#202836">
        {/* Titre de section */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {expertiseCards.map((card, index) => (
            <div
              key={index}
              className="group bg-[#252A34] rounded-lg p-6 transition-all duration-300
                         hover:shadow-lg hover:shadow-orange-500/5
                         border border-gray-700/30 hover:border-orange-500/20"
              style={{
