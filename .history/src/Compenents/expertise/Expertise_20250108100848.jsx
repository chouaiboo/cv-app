      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {expertiseCards.map((card, index) => (
            ...
            >
              <div className={`h-full p-8 rounded-2xl bg-gradient-to-br ${card.color} backdrop-blur-xl border border-gray-700/50 transition-all duration-500 ease-out group-hover:scale-[1.02] group-hover:border-gray-600`}>
                ...
                <div className="flex flex-wrap gap-2">
                  {card.technologies.map((tech, i) => (
                    <span
                      key={i}
                      className="px-3 py-1 text-sm bg-gray-800/80 text-orange-400 rounded-full border border-gray-700 hover:border-orange-400/50 transition-colors duration-300"
                    >
                      {tech}
                    </span>
                  ))}
