...
export default function Home() {
  return (
    <div id='Home' className="relative">
      ...
      <div className="absolute top-1/2 right-1/4 transform rotate-45 z-10 mb-10">
        <div className="w-40 h-20 bg-[#D27548] opacity-80"></div>
      </div>

      {/* Cercle décoratif avec dégradé */}
      <div className="absolute top-1/2right-1/3 z-10">
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20 text-center text-white">
        ...
        <h2 className="text-2xl md:text-5xl font-medium mt-4">FULL STACK DEVELOPER</h2>
      </div>

      {/* Section "AS FEATURED IN" */}
      <div className="absolute bottom-16 left-1/2 transform -translate-x-1/2 text-center z-20">
        <p className="text-white mb-6">AS FEATURED IN</p>
        <div className="flex gap-8 items-center justify-center opacity-70">
          <span className="text-white">CareerFoundry</span>
          <span className="text-white">Frontend Mentor</span>
          <span className="text-white">WeAreDevelopers</span>
          <span className="text-white">Colorlib</span>
          <span className="text-white">Masai</span>
        </div>
      </div>
    </div>
  );
