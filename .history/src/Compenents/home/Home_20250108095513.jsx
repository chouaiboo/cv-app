...
import { Motion, Sun, Code, Smartphone } from 'lucide-react';
  ...
  return (
    <>
      ...
      <div className="fixed top-0 left-0 w-full h-screen z-0" id='home'>
        ...
        <div 
          className=`absolute inset-0 bg-[url(`${image})] bg-cover bg-center bg-no-repeat`
          style={{
      ...
      <div id='Home' className="relative min-h-screen overflow-hidden">
        ...
        >
          ...
          <div className="mt-12 flex gap-4 justify-center">
            {['React', 'Node.js', 'Mobile', 'UI/UX'].map((skill, index) => (
              <div 
                key={skill}
