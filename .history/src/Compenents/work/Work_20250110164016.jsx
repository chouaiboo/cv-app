...
export default function WorkSection() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Tableau de bord pour la visualisation de données en temps réel",
      image: "/api/placeholder/600/400",
      category: "web",
  ...
  return (
    <div className="min-h-screen bg-[#1B202A] py-20 px-4" id="work">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProjects.map((project, index) => (
            <div
              key={index}
              className="group relative bg-[#252A34] rounded-xl overflow-hidden
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {project.technologies.map((tech, i) => (
                    <span
                      key={i}
                      className="px-3 py-1 text-xs bg-[#1B202A] text-gray-400 rounded-full
