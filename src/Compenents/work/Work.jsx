...
import cv from '../../image/cv.avif';
import meteo from '../../image/meteo.avif'
import todo from '../../image/todo.avif'
...
export default function WorkSection() {
  ...
  const projects = [
    ...
    {
      title: "app to do liste",
      description: "Application de todolist ",
      image: todo,
      category: "mobile",
      ...
      githubLink: "https://github.com/example"
        ...
        {
            title: "wethear  App",
            description: "Application de savoir temperature",
            image: meteo,
            category: "web",
            technologies: ["react", "api","tawlwind"],
            demoLink: "https://demo.example.com",
            githubLink: "https://github.com/example"
    }
  ];
